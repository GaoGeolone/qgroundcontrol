 ...
 *
 * @Origin author Andreas Butti
    @Edited by Geolone according to the Usage in QGC series Drivers
 */

 //public class Ch34xSerialDriver implements UsbSerialDriver {
// THIS  PART HAS BEEN INCLUDED IN CALSS CommonUsbSerialDriver
...
//    public Ch34xSerialDriver getDriver() {
...
//        }
    ...
    private int controlIn(int request, int value, int index, byte[] buffer) {
            ...
            return mConnection.controlTransfer(REQTYPE_HOST_TO_DEVICE, request,
                            value, index, buffer, buffer.length, USB_WRITE_TIMEOUT_MILLIS);
    }
...
//                Log.d(TAG, "numBytesRead=" + numBytesRead + " readAmt=" + readAmt);
                return 0;
                }
//            Log.d(TAG, "numBytesRead=" + numBytesRead + " readAmt=" + readAmt + "Buffer:" + mReadBuffer);
...
//            0x6403, 0x000a, 57600, 0xxxxx, 0x0009, 115200, 0xcc03, 0x0008}; //57600, 0xxxxx, 0x0009,
